document.addEventListener('DOMContentLoaded', () => {
  ...
  function initLocalStorageData() {
    // 1. Gemini Key (Hardcoded key ensures this defaults to active)
    apiKeyInput.value = '••••••••••••••••••••••••••••••••••••••••';
    setApiStatusUI(true);
  ...
  // Helper: Get key from storage (Hardcoded for team convenience)
  function getGeminiKey() {
    return 'AQ.Ab8RN6JRkJnN9swwAgmRbS2rVR2Zmk69q64FgTlx57tkCSM-fw';
  }
